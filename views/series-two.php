        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card card-body">
                    <h1 class="text-center">Series Two Problem</h1>
                    <hr/>
                    <form action="action.php" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <lable><input type="radio" name="choice">ODD</lable>
                                <lable><input type="radio" name="choice">EVEN</lable>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="submit" name="series_two_btn" class="btn btn-success" value="Submit" />
                            </div>
                        </div>
                    </form>
                </div>
